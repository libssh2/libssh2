 ...
 *
 * Modified by Will Cosgrove for libssh2
 *
...
OPENSSL_EXPORT void BO_X25519_keypair(uint8_t out_public_value[32],
...
OPENSSL_EXPORT int BO_X25519(uint8_t out_shared_key[32],
...
OPENSSL_EXPORT void BO_X25519_public_from_private(uint8_t out_public_value[32],
                                               const uint8_t private_key[32]);
 ...
 * generated, public–private key pair. */
OPENSSL_EXPORT void BO_ED25519_keypair(uint8_t out_public_key[32],
 ...
 * private key. */
OPENSSL_EXPORT void BO_ED25519_keypair_from_seed(uint8_t out_public_key[32],
                               uint8_t out_private_key[64],
 ...
 * error. */
OPENSSL_EXPORT int BO_ED25519_sign(uint8_t out_sig[64], const uint8_t *message,
                                size_t message_len,
 ...
 * otherwise. */
OPENSSL_EXPORT int BO_ED25519_verify(const uint8_t *message, size_t message_len,
