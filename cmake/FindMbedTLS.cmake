...
if(MBEDTLS_FOUND AND NOT TARGET libssh2::MbedCrypto)
  ...
  set_target_properties(libssh2::MbedCrypto PROPERTIES
    ...
    LIBSSH2_PC_MODULES "${MBEDTLS_PC_REQUIRES}"
    INTERFACE_COMPILE_OPTIONS "${MBEDTLS_CFLAGS}"
  ...
  if(CMAKE_VERSION VERSION_LESS 3.13)
    ...
    target_link_directories(libssh2::MbedCrypto INTERFACE ${MBEDTLS_LIBRARY_DIRS})
  endif()
  target_link_libraries(libssh2::MbedCrypto INTERFACE ${MBEDTLS_LIBRARIES})
endif()
