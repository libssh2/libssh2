...
# host certificates
ssh-keygen       -h -I "host_ed25519" -n "${pr},localhost" -s 'keys/ca_host_ed25519'         'openssh_server/ssh_host_ed25519_key.pub'
